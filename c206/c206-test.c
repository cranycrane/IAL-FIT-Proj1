...
DLL_First(test_list);
DLL_Next(test_list);
DLL_DeleteBefore(test_list); // smazal 0, prvni prvek je 1
assert(DLL_IsActive(test_list));
DLL_Previous(test_list);
assert(!DLL_IsActive(test_list));

DLL_Last(test_list); // je na 9
DLL_Previous(test_list); // 8
DLL_DeleteAfter(test_list); // smazal 9
assert(DLL_IsActive(test_list)); //
DLL_Next(test_list);
assert(!DLL_IsActive(test_list));

DLL_First(test_list); // je na 1
for (int i = 1; i < 9; i++) {
    assert(DLL_IsActive(test_list));
    DLL_GetValue(test_list, &tmp);
    assert(tmp == i);
...
DLL_InsertFirst(test_list, -100); // prvni je -100, druhy 1, posledni 8
DLL_First(test_list);
DLL_GetValue(test_list, &tmp);
assert(tmp == -100);
DLL_DeleteFirst(test_list); // prvni je 1, posledni 8
assert(!DLL_IsActive(test_list));
DLL_First(test_list);
DLL_GetValue(test_list, &tmp);
assert(tmp == 1);

DLL_InsertLast(test_list, 100); // prvni je 1, posledni 100
DLL_Last(test_list);
DLL_GetValue(test_list, &tmp);
assert(tmp == 100);
DLL_DeleteLast(test_list); // prvni je 1, posledni 8
assert(!DLL_IsActive(test_list));
DLL_Last(test_list);
DLL_GetValue(test_list, &tmp);
assert(tmp == 8);
